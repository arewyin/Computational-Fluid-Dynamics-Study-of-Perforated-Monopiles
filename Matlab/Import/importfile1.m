function Reference13Dataexpmeshbound = importfile1(filename, dataLines)
%IMPORTFILE1 Import data from a text file
%  REFERENCE13DATAEXPMESHBOUND = IMPORTFILE1(FILENAME) reads data from
%  text file FILENAME for the default selection.  Returns the data as a
%  table.
%
%  REFERENCE13DATAEXPMESHBOUND = IMPORTFILE1(FILE, DATALINES) reads data
%  for the specified row interval(s) of text file FILENAME. Specify
%  DATALINES as a positive scalar integer or a N-by-2 array of positive
%  scalar integers for dis-contiguous row intervals.
%
%  Example:
%  Reference13Dataexpmeshbound = importfile1("F:\School\FIT\Thesis\Scaled Simulations\Reference_13-Data-exp mesh bound.csv", [2, Inf]);
%
%  See also READTABLE.
%
% Auto-generated by MATLAB on 23-Aug-2023 19:17:26
...
% Import the data
Reference13Dataexpmeshbound = readtable(filename, opts);
