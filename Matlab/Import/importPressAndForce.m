function Reference8 = importPressAndForce(filename, startRow, endRow)
%IMPORTFILE3 Import numeric data from a text file as a matrix.
%   REFERENCE8 = IMPORTFILE3(FILENAME)
%   Reads data from text file FILENAME for the default selection.
%
%   REFERENCE8 = IMPORTFILE3(FILENAME, STARTROW, ENDROW)
%   Reads data from rows STARTROW through ENDROW of text file FILENAME.
%
% Example:
%   Reference8 = importPressAndForce('Reference_8.txt', 9, 1002);
%
%    See also TEXTSCAN.

% Auto-generated by MATLAB on 2024/02/08 12:31:21
...
Reference8 = table(dataArray{1:end-1}, 'VariableNames', {'time','p_1','p_2','pfyob_1'});
