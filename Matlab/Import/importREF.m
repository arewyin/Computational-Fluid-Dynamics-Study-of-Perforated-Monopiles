function Perforation113withRefPoint = importREF(filename, startRow, endRow)
%IMPORTFILE2 Import numeric data from a text file as a matrix.
%   PERFORATION113WITHREFPOINT = IMPORTFILE2(FILENAME)
%   Reads data from text file FILENAME for the default selection.
%
%   PERFORATION113WITHREFPOINT = IMPORTFILE2(FILENAME, STARTROW, ENDROW)
%   Reads data from rows STARTROW through ENDROW of text file FILENAME.
%
% Example:
%   Perforation113withRefPoint = importREF('Perforation_1_13_with Ref Point.txt', 9, 1011);
%
%    See also TEXTSCAN.

% Auto-generated by MATLAB on 2023/09/11 16:32:47
...
Perforation113withRefPoint = table(dataArray{1:end-1}, 'VariableNames', {'time','p_1','pfxob_1','pfyob_1','pfzob_1','pfob_1','tfmxob_1','tfmyob_1','tfmzob_1','tfmob_1'});
