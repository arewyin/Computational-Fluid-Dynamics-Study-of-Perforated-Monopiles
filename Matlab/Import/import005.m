function Reference13005 = import005(filename, startRow, endRow)
%IMPORTFILE2 Import numeric data from a text file as a matrix.
%   REFERENCE13005 = IMPORTFILE2(FILENAME)
%   Reads data from text file FILENAME for the default selection.
%
%   REFERENCE13005 = IMPORTFILE2(FILENAME, STARTROW, ENDROW)
%   Reads data from rows STARTROW through ENDROW of text file FILENAME.
%
% Example:
%   Reference13005 = import005('Reference_13_005.txt', 9, 1011);
%
%    See also TEXTSCAN.

% Auto-generated by MATLAB on 2023/08/31 13:07:51
...
Reference13005 = table(dataArray{1:end-1}, 'VariableNames', {'time','p_1','pfxob_1','pfyob_1','pfzob_1','pfob_1','vmax_0','vmaxsrf_0'});
